...
class CleaningItems extends StatelessWidget {
  const CleaningItems({
    required this.items,
    super.key,
  });

  final List<CleaningActivity> items;
        ...
        children: [
          ...
          SizedBox(
            ...
            child: DataTable(
              ...
              rows: List.generate(
                items.length,
                (index) => itemsDataRow(items[index], context),
              ),
            ),
          ),
        ],
      ...
      DataCell(
        ...
        onTap: () {
          context.read<DashboardBloc>().add(
                DashboardDeleteCleaningActivity(crime),
              );

          context.read<DashboardBloc>().add(
                DashboardLoadCleaning(crime.crimeId),
              );
        },
      ),
    ],

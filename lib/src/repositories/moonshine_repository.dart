...
class MoonshineRepository {
  ...
  Future<MoonshineActivity> getMoonshineActivity(String orgId, String crimeId) async {
  ...
  Future createMoonshineActivity(String orgId, MoonshineActivity moonshineActivity) async {
    await _moonshineAPI.createMoonshineData(orgId, moonshineActivity);
  }

  Future updateMoonshineActivity(String orgId, MoonshineActivity moonshineActivity) async {
